...
// 1. On success this function returns -1 otherwise it will return 0-based mutex index number which it
//    could not lock.
...
//    re-throwing.
// 4. The actual use of std::trylock() is, it can try to lock multiple mutex object at the same time.
